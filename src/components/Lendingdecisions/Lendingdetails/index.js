            ...
            <div className="productdetails one pt-4">
                <Container>
                  <Row className="align-items-center">  
                    ...
                    <Col lg="6" className="pr-lg-5 animate__animated animate__fadeInLeft wow" data-wow-duration="3s">
            ...
            <div className="productdetails">
              <Container>
                <Row className="align-items-center">  
                  ...
                  <Col lg="6" className="pr-lg-5 animate__animated animate__fadeInRight wow" data-wow-duration="3s">
